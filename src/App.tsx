...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-gray-100 text-gray-800">
      {/* Navigation Bar */}
      ...
      <header className="pt-24 pb-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text">
            ...
            <div className="flex gap-4">
              <a
                href="#contact"
                className="btn-primary hover:shadow-lg transform transition-transform duration-300"
              >
                Get in Touch
              </a>
              <a
                href="#projects"
                className="btn-secondary hover:shadow-lg transform transition-transform duration-300"
              >
                View Projects
              </a>
            </div>
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex justify-center space-x-8">
          <a href="https://github.com/VemulaDowtyasriprasanth" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary transition-colors">
            <Github size={24} />
          </a>
          <a href="https://linkedin.com/in/dsp1729/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary transition-colors">
            <Linkedin size={24} />
          </a>
          <a href="mailto:prasanthvemula1729@gmail.com" className="text-gray-600 hover:text-primary transition-colors">
            <Mail size={24} />
          </a>
        </div>
      </section>
